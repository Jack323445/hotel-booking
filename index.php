...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/reg.avif" style="width:100%; height:180px;">
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              <h4><strong style="color: #1dc4b1">About</strong></h4><br>
        ...
        <div class="row" style="color: #1dc4b1">
